...
const analyzeAnswers = (req, res) => {
    const { answers } = req.body; // دریافت آرایه از پاسخ‌ها
    ...
    res.send({
        ...
        data: {
            ...
            backEndScore,
            uiUxScore,
            result,  // result شامل پیام‌ها و نتیجه نهایی
        },
    });
};
